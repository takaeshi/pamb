...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/gwenstephanie/python-aria-mirror-bot/tree/master)
...
[![Run](https://img.shields.io/badge/Run%20Online-Red)](https://Generate-Drive-Token.khaleefah.repl.run)

**Termux:**

``` pkg install python wget ```

``` wget https://raw.githubusercontent.com/Gwenstephanie/pamb/master/generate_drive_token.py ```
...
[![Run](https://img.shields.io/badge/Run%20Online-Red)](https://StringSession.khaleefah.repl.run)

**Termux:**

``` pkg install python wget ``` (if not installed earlier)

``` wget https://raw.githubusercontent.com/Gwenstephanie/pamb/master/generate_string_session.py ```
